...
fit_agr <- survfit(weib_2, newdata = agr_df_1)
ggsurvplot(fit_agr,
           conf.int = TRUE,
...
# Cox Model
rob_1.4 <-    coxph(Surv(time, treaty_yes) ~ agr_cum + commission_cum + monitoring_cum + conflict_cum,
                    cluster = dyad_id, data = dyadicdat[dyadicdat$year >= 1980 | dyadicdat$year == 0,])
rob_2.4 <-    coxph(Surv(time, treaty_yes) ~ agr_cum + commission_cum + monitoring_cum + conflict_cum +	pollution	+ shipping + fish + construction + symmetry + bi_lingue,
                    cluster = dyad_id, data = dyadicdat[dyadicdat$year >= 1980 | dyadicdat$year == 0,])
rob_3.4 <-    coxph(Surv(time, any_mech_yes) ~ agr_cum + commission_cum + monitoring_cum + conflict_cum,
                    cluster = dyad_id, data = dyadicdat[dyadicdat$year >= 1980 | dyadicdat$year == 0,])
rob_4.4 <-    coxph(Surv(time, any_mech_yes) ~ agr_cum + commission_cum + monitoring_cum + conflict_cum +	pollution	+ shipping +	fish + construction + symmetry + bi_lingue,
                    cluster = dyad_id, data = dyadicdat[dyadicdat$year >= 1980 | dyadicdat$year == 0,])
rob_5.4 <-   coxph(Surv(time, commission) ~ agr_cum + commission_cum + monitoring_cum + conflict_cum,
                    cluster = dyad_id, data = dyadicdat[dyadicdat$year >= 1980 | dyadicdat$year == 0,])
rob_6.4 <-   coxph(Surv(time, commission) ~ agr_cum + commission_cum + monitoring_cum + conflict_cum +	pollution	+ shipping +	fish + construction + symmetry + bi_lingue,
                    cluster = dyad_id, data = dyadicdat[dyadicdat$year >= 1980 | dyadicdat$year == 0,])
rob_7.4 <-   coxph(Surv(time, mon_cant) ~ agr_cum + commission_cum + monitoring_cum + conflict_cum,
                    cluster = dyad_id, data = dyadicdat[dyadicdat$year >= 1980 | dyadicdat$year == 0,])
rob_8.4 <-   coxph(Surv(time, mon_cant) ~ agr_cum + commission_cum + monitoring_cum + conflict_cum +	pollution	+ shipping +	fish + construction + symmetry + bi_lingue,
                    cluster = dyad_id, data = dyadicdat[dyadicdat$year >= 1980 | dyadicdat$year == 0,])
rob_9.4 <-     coxph(Surv(time, conflict) ~ agr_cum + commission_cum + monitoring_cum + conflict_cum,
                    cluster = dyad_id, data = dyadicdat[dyadicdat$year >= 1980 | dyadicdat$year == 0,])
rob_10.4 <-     coxph(Surv(time, conflict) ~ agr_cum + commission_cum + monitoring_cum + conflict_cum +	pollution	+ shipping  + construction + symmetry + bi_lingue,
                    cluster = dyad_id, data = dyadicdat[dyadicdat$year >= 1980 | dyadicdat$year == 0,])
