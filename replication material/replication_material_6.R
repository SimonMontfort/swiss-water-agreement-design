...
output2.1 <- survreg(Surv(time, any_mech_yes) ~ agr_cum + commission_cum + monitoring_cum + conflict_cum 
                     + cluster(dyad_id), data = dyadicdat[dyadicdat$year >= 1980 | dyadicdat$year == 0,], dist = "weibull")
output2.2 <- survreg(Surv(time, any_mech_yes) ~ agr_cum + commission_cum + monitoring_cum + conflict_cum 
                     +	pollution	+ shipping +	fish + construction
                     + symmetry + bi_lingue + cluster(dyad_id), data = dyadicdat[dyadicdat$year >= 1980 | dyadicdat$year == 0,], dist = "weibull")
output3.1 <- survreg(Surv(time, commission) ~ agr_cum + commission_cum + monitoring_cum + conflict_cum 
                     + cluster(dyad_id), data = dyadicdat[dyadicdat$year >= 1980 | dyadicdat$year == 0,], dist = "weibull")
output3.2 <- survreg(Surv(time, commission) ~ agr_cum + commission_cum + monitoring_cum + conflict_cum 
                     +	pollution	+ shipping +	fish + construction
                     + symmetry + bi_lingue + cluster(dyad_id), data = dyadicdat[dyadicdat$year >= 1980 | dyadicdat$year == 0,], dist = "weibull")
output4.1 <- survreg(Surv(time, monitoring) ~ agr_cum + commission_cum + monitoring_cum + conflict_cum
                     + cluster(dyad_id), data = dyadicdat[dyadicdat$year >= 1980 | dyadicdat$year == 0,], dist = "weibull")
output4.2 <- survreg(Surv(time, monitoring) ~ agr_cum + commission_cum + monitoring_cum + conflict_cum 
                     +	pollution	+ shipping +	fish + construction
                     + symmetry + bi_lingue + cluster(dyad_id), data = dyadicdat[dyadicdat$year >= 1980 | dyadicdat$year == 0,], dist = "weibull")
output5.1 <- survreg(Surv(time, conflict) ~ agr_cum + commission_cum + monitoring_cum + conflict_cum
                     + cluster(dyad_id), data = dyadicdat[dyadicdat$year >= 1980 | dyadicdat$year == 0,], dist = "weibull")
output5.2 <- survreg(Surv(time, conflict) ~ agr_cum + commission_cum + monitoring_cum + conflict_cum 
                     +	pollution	+ shipping +	fish + construction
                     + symmetry + bi_lingue + cluster(dyad_id), data = dyadicdat[dyadicdat$year >= 1980 | dyadicdat$year == 0,], dist = "weibull")

model_list1 <- list(output1.1, output1.2, output2.1, output2.2, output3.1, output3.2, output4.1, output4.2, output5.1, output5.2)
...
output1.3 <- survreg(Surv(time, treaty_yes) ~ agr_cum + commission_cum + monitoring_cum + conflict_cum 
                     + cluster(dyad_id), data = dyadicdat[dyadicdat$year >= 1980 | dyadicdat$year == 0,], dist = "exponential")
output1.4 <- survreg(Surv(time, treaty_yes) ~ agr_cum + commission_cum + monitoring_cum + conflict_cum 
                     +	pollution	+ shipping +	fish + construction
                     + symmetry + bi_lingue + cluster(dyad_id), data = dyadicdat[dyadicdat$year >= 1980 | dyadicdat$year == 0,], dist = "exponential")
output2.3 <- survreg(Surv(time, any_mech_yes) ~ agr_cum + commission_cum + monitoring_cum + conflict_cum 
                     + cluster(dyad_id), data = dyadicdat[dyadicdat$year >= 1980 | dyadicdat$year == 0,], dist = "exponential")
output2.4 <- survreg(Surv(time, any_mech_yes) ~ agr_cum + commission_cum + monitoring_cum + conflict_cum 
                     +	pollution	+ shipping +	fish + construction
                     + symmetry + bi_lingue + cluster(dyad_id), data = dyadicdat[dyadicdat$year >= 1980 | dyadicdat$year == 0,], dist = "exponential")
output3.3 <- survreg(Surv(time, commission) ~ agr_cum + commission_cum + monitoring_cum + conflict_cum 
                     + cluster(dyad_id), data = dyadicdat[dyadicdat$year >= 1980 | dyadicdat$year == 0,], dist = "exponential")
output3.4 <- survreg(Surv(time, commission) ~ agr_cum + commission_cum + monitoring_cum + conflict_cum 
                     +	pollution	+ shipping +	fish + construction
                     + symmetry + bi_lingue + cluster(dyad_id), data = dyadicdat[dyadicdat$year >= 1980 | dyadicdat$year == 0,], dist = "exponential")
output4.3 <- survreg(Surv(time, monitoring) ~ agr_cum + commission_cum + monitoring_cum + conflict_cum
                     + cluster(dyad_id), data = dyadicdat[dyadicdat$year >= 1980 | dyadicdat$year == 0,], dist = "exponential")
output4.4 <- survreg(Surv(time, monitoring) ~ agr_cum + commission_cum + monitoring_cum + conflict_cum 
                     +	pollution	+ shipping +	fish + construction
                     + symmetry + bi_lingue + cluster(dyad_id), data = dyadicdat[dyadicdat$year >= 1980 | dyadicdat$year == 0,], dist = "exponential")
output5.3 <- survreg(Surv(time, conflict) ~ agr_cum + commission_cum + monitoring_cum + conflict_cum
                     + cluster(dyad_id), data = dyadicdat[dyadicdat$year >= 1980 | dyadicdat$year == 0,], dist = "exponential")
output5.4 <- survreg(Surv(time, conflict) ~ agr_cum + commission_cum + monitoring_cum + conflict_cum 
                     +	pollution	+ shipping +	fish + construction
                     + symmetry + bi_lingue + cluster(dyad_id), data = dyadicdat[dyadicdat$year >= 1980 | dyadicdat$year == 0,], dist = "exponential")

model_list2 <- list(output1.1, output1.2, output2.1, output2.2, output3.1, output3.2, output4.1, output4.2, output5.1, output5.2)
