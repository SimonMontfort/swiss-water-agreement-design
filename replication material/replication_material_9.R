...
# Robustness Checks 3: Weibull parametric model
exp_1 <- survreg(Surv(time, treaty_yes) ~ agr_cum + commission_cum + monitoring_cum + conflict_cum + cluster(dyad_id), dist = "exponential")
exp_2 <- survreg(Surv(time, treaty_yes) ~ agr_cum + commission_cum + monitoring_cum + conflict_cum + pollution	+ shipping +	fish + construction + symmetry + bi_lingue + cluster(dyad_id), dist = "weibull")
exp_3 <- survreg(Surv(time, any_mech_yes) ~ agr_cum + commission_cum + monitoring_cum + conflict_cum + cluster(dyad_id), dist = "exponential")
exp_4 <- survreg(Surv(time, any_mech_yes) ~ agr_cum + commission_cum + monitoring_cum + conflict_cum + pollution	+ shipping +	fish + construction + symmetry + bi_lingue + cluster(dyad_id), dist = "weibull")
exp_5 <- survreg(Surv(time, commission) ~ agr_cum + commission_cum + monitoring_cum + conflict_cum + cluster(dyad_id), dist = "exponential")
exp_6 <- survreg(Surv(time, commission) ~ agr_cum + commission_cum + monitoring_cum + conflict_cum + pollution	+ shipping +	fish + construction + symmetry + bi_lingue + cluster(dyad_id), dist = "weibull")
exp_7 <- survreg(Surv(time, monitoring) ~ agr_cum + commission_cum + monitoring_cum + conflict_cum + cluster(dyad_id), dist = "exponential")
exp_8 <- survreg(Surv(time, monitoring) ~ agr_cum + commission_cum + monitoring_cum + conflict_cum + pollution	+ shipping +	fish + construction + symmetry + bi_lingue + cluster(dyad_id), dist = "weibull")
exp_9 <- survreg(Surv(time, conflict) ~ agr_cum + commission_cum + monitoring_cum + conflict_cum + cluster(dyad_id), dist = "exponential")
exp_10 <- survreg(Surv(time, conflict) ~ agr_cum + commission_cum + monitoring_cum + conflict_cum + pollution	+ shipping  + construction + symmetry + bi_lingue + cluster(dyad_id), dist = "weibull")
...
model_list_rob_3 <- list(exp_1, exp_2, exp_3, exp_4, exp_5, exp_6, exp_7, exp_8, exp_9, exp_10)
...
fit_agr_1 <- survfit(cox_4, newdata = agr_df_1)
...
fit_agr_2 <- survfit(cox_10, newdata = agr_df_2)
...
cox_2_tt <- coxph(Surv(time, treaty_yes) ~ agr_one + tt(agr_one) + commission_one + monitoring_one + tt(monitoring_one) + conflict_one + pollution	+ shipping +	fish + construction + symmetry + bi_lingue, cluster = dyad_id)
cox_4_tt <- coxph(Surv(time, any_mech_yes) ~ agr_one + tt(agr_one) + commission_one + monitoring_one + tt(monitoring_one) + conflict_one + pollution	+ shipping +	fish + construction + symmetry + bi_lingue, cluster = dyad_id)
cox_6_tt <- coxph(Surv(time, commission) ~ agr_one + commission_one + monitoring_one + tt(monitoring_one) + conflict_one + pollution	+ shipping +	fish + construction + symmetry + bi_lingue, cluster = dyad_id)
cox_10_tt <- coxph(Surv(time, conflict) ~ agr_one + tt(agr_one) + commission_one + monitoring_one + tt(monitoring_one) + conflict_one + tt(conflict_one) + pollution	+ shipping + construction + symmetry + bi_lingue, cluster = dyad_id)
